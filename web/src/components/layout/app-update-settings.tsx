...
import { APP_RELEASES_URL, useVersionCheck } from "@/hooks/use-version-check";
...
export function AppUpdateSettings() {
    ...
    return (
        <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="min-w-0">
                        <div className="flex items-center gap-2 text-sm font-semibold">
                            软件更新
                            <Tag className="m-0 font-mono">v{APP_VERSION}</Tag>
                        </div>
            ...
            {releases.length ? (
                <section className="rounded-xl border border-stone-200 p-4 dark:border-stone-800">
                    <div className="mb-4 text-sm font-semibold">版本记录</div>
                    <Timeline
