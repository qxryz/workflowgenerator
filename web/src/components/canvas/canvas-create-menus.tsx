...
import { ImageIcon, List, Music2, Settings2, Terminal, Video, X } from "lucide-react";
...
export function ConnectionCreateMenu({
    ...
    onCreate: (type: CanvasNodeType.Image | CanvasNodeType.Text | CanvasNodeType.Config | CanvasNodeType.Video | CanvasNodeType.Audio | CanvasNodeType.Terminal) => void;
    onClose: () => void;
}) {
    ...
    return (
        ...
        >
            ...
            <div className="grid gap-1">
                ...
                <ConnectionCreateOption theme={theme} icon={<Terminal className="size-5" />} title="终端 Agent" description="运行本机 CLI 并保留输出" onClick={() => onCreate(CanvasNodeType.Terminal)} />
            </div>
        </div>
    );
}
