...
export const ConnectionPath = memo(function ConnectionPath({
    ...
    const stroke = active ? theme.node.activeStroke : "#4f8cff";
    ...
    return (
        <g>
            ...
            <path
                ...
                fill="none"
                markerEnd="url(#workflow-connection-arrow)"
                style={{ filter: active ? `drop-shadow(0 0 8px ${theme.node.activeStroke}66)` : "drop-shadow(0 0 4px rgba(79,140,255,.22))", pointerEvents: "none" }}
            />
        </g>
    );
});
