...
export const NODE_DEFAULT_SIZE = {
    ...
    [CanvasNodeType.File]: { width: 340, height: 176, title: "文件" },
    ...
    [CanvasNodeType.Terminal]: { width: 560, height: 430, title: "终端 Agent" },
...
export const NODE_SPECS = {
    ...
    [CanvasNodeType.File]: {
        ...NODE_DEFAULT_SIZE[CanvasNodeType.File],
    ...
    [CanvasNodeType.Terminal]: {
        ...NODE_DEFAULT_SIZE[CanvasNodeType.Terminal],
        metadata: { status: "idle", terminalCommand: "", terminalOutput: "", terminalInputMode: "auto", terminalOutputMode: "text", terminalOutputValue: "", terminalSessionVersion: 0, terminalFontSize: 12, terminalConfigured: false },
    },
